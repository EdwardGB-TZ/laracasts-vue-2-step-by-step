...
var routes = [{
  path: '/',
  components: __webpack_require__(/*! ./views/Home.vue */ "./resources/js/views/Home.vue")
}, {
  path: '/about',
  components: __webpack_require__(/*! ./views/About.vue */ "./resources/js/views/About.vue")
}, {
  path: '/contact',
  components: __webpack_require__(/*! ./views/Contact */ "./resources/js/views/Contact.vue")
}];
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "container" }, [
      ...
      _vm._v(" "),
      _c("h2", [_vm._v("Example component")])
    ])
  }
]
